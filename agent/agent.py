...
class EventResearchAgent(AgentWithTools):
    ...
    def _create_event_research_function_declaration(self) -> FunctionDeclaration:
        function = FunctionDeclaration(
            ...
            description="Process HTML structure of page, Find events, and extract information in a structured format",
            parameters={
                "type": "object",
                "properties": {
                    "events": {
                        ...
                        "items": {
                            ...
                            "properties": {
                                ...
                                "detail_link":{
                                "type": "string",
                                    "description": "A link to view more details about the event, often in a <button> or <a> element, often relates to the event name, may be a relative link. Example: ",
                                },
                                "event_details": {
                                    "type": "object",
                                    "properties": {
                            ...
                            "required": ["title", "content", "event_details", "detail_link"],
                        },
                    }
                },
                "required": ["events"],
